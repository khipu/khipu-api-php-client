...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = "khipu-api-php-client/2.8.6";
    ...
    {
        $this->userAgent = "khipu-api-php-client/2.8.6|".$name."/".$version;
    }
    ...
    public static function toDebugReport()
    {
        ...
        $report .= "    Swagger Spec Version: 2.8.6\n";
        $report .= "    SDK Package Version: 2.8.6\n";
